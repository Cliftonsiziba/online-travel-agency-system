...
<%
 ...
 Connection conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/test?serverTimezone=GMT","root","clementine1994");//connect to the database
 Statement stmt=conn.createStatement();
 String queryNumberSQL="SELECT * from user where username='"+name+"' and userpassword='"+password+"'"; //check the typed name and password
